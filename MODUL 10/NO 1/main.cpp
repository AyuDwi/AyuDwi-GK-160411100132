...
void sampingkiri (){
    ...
    glTranslated(0.1,7.5,0.0);
    angka(0.0,0.0,1.0);
    glTranslated(0.0,-3.65,-0.3);
    angka(0.0,0.0,1.0); //TENH
    glPopMatrix();
...
void reshape (int w, int h)
{
    ...
    glLoadIdentity();
    if (w <= h)         glOrtho (-25.0, 25.0, -25.0*(GLfloat)h/(GLfloat)w, 25.0*(GLfloat)h/(GLfloat)w, - 75.0, 75.0);
